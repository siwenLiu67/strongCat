...
class OutputPrinter:
    """Utility class for printing and visualizing results"""
    def __init__(self, test_results, schedule):
    ...
    def generate_comparison_plots(self):
        ...
        for i, metric in enumerate(metrics):
            values = [res[metric] for res in self.test_results]
            plt.subplot(1, 3, i+1)
    ...
    def plot_gantt_chart(self, filename='results/gantt_chart.png'):
        """Generate Gantt chart visualization of schedule"""
        fig, ax = plt.subplots(figsize=(12, 8))
        
        colors = cm.get_cmap('tab20', len(self.schedule['jobs']))
